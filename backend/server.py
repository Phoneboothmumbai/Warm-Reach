...
async def calculate_next_schedule_date(tenant_id: str, contact_id: str, now: datetime) -> datetime:
    ...
    try:
        ...
        if last_contact_date:
            ...
            min_next_date = last_contact_date + timedelta(days=14)
        ...
        for _ in range(max_attempts):
            ...
            # Check if this contact already has a message on this day
            ...
            # Check monthly limit for this contact (max 2 per month)
            month_start = candidate_date.replace(day=1, hour=0, minute=0, second=0, microsecond=0)
        ...
        logger.error(f"Error calculating schedule date: {e}")
